...
export function Onboarding({ onClose }: Props) {
  ...
  const steps = [
    {
      eyebrow: 'PokeAlert',
      title: 'Les drops avant les autres.',
      subtitle: 'Suivi des sorties Pokémon TCG en FNAC Paris.',
      bg: 'aurora-primary',
      highlight: 'avant',
      icon: Icon.Target,
      stat: { value: '22', label: 'produits' },
      stat2: { value: '9', label: 'magasins' },
      stat3: { value: '24/7', label: 'monitoring' },
    },
    {
      eyebrow: 'Comment ça marche',
      title: 'Trois sources, une réponse.',
      subtitle: 'Calendrier officiel, jours de livraison FNAC et stock observé. Chaque matin, top 3 magasins du jour.',
      bg: 'aurora-success',
      highlight: 'réponse',
      icon: Icon.Compass,
      features: [
        { icon: Icon.Compass, label: 'Top 3 magasins par jour' },
        { icon: Icon.BellRing, label: 'Alerte Telegram quand drop' },
        { icon: Icon.Navigation, label: 'Itinéraire métro et rayon' },
      ],
    },
    {
      eyebrow: 'Premier drop',
      title: 'ME05 — Nuit Noire',
      subtitle: 'Sortie le 17 juillet. Alerte J-7, J-3, J-1 et le matin du drop.',
      bg: 'aurora-hot',
      highlight: 'ME05',
      icon: Icon.Flame,
